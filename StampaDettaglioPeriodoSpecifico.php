...
// ----------------------------------------------------------------------
// Nome file:  StampaDettaglioPeriodoSpecifico.php
// Autore di questo file: Sophia Danesino
// Descrizione: stampa per un periodo specifico di frequenza ad una scuola 
...
$title = "Prospetto scolastico studente per periodo";
...
<?	
	...
	// Visualizza periodo di frequenza in scuola ospedaliera
		...
		{ //while01
			...
			if ($riga) {
				print '<p><font size=2"><br><table width="100%" style="border:0px solid; border-collapse:collapse;" ><th colspan="5"><center><font size="3">'.$riga_materia['nome'].'</font></center><br></th><tr></tr>';
				...
				<td width="35%" style="border:1px solid;"><b>Osservazioni</b></td>
				<td width="10%" style="border:1px solid;"><b>Valutazioni</b></td></tr>';
				...
				do {
					...
					<td align='left' valign='top' style='border:1px solid;'>".$riga['argomenti']."</td>
					<td align='left' valign='top' style='border:1px solid;'>".$riga['osservazioni']."</td>
					<td align='left' valign='top' style='border:1px solid;'>".$riga['valutazione']."</td></tr>";
				}
